...
// NOTE: types only partially working.
// The browser specific version of MQTT is in mqtt/dist/mqtt.min. I'm stealing some types from the NODE version
// until the browser types are found or fixed. 
...
// Press ctrl spacebar in brackets to see options.
